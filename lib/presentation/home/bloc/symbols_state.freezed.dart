...
/// @nodoc
abstract class $SymbolsStateCopyWith<T, $Res> {
  factory $SymbolsStateCopyWith(
          SymbolsState<T> value, $Res Function(SymbolsState<T>) then) =
      _$SymbolsStateCopyWithImpl<T, $Res, SymbolsState<T>>;
}

/// @nodoc
class _$SymbolsStateCopyWithImpl<T, $Res, $Val extends SymbolsState<T>>
    implements $SymbolsStateCopyWith<T, $Res> {
  _$SymbolsStateCopyWithImpl(this._value, this._then);
...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$SymbolsStateCopyWithImpl<T, $Res, _$Idle<T>>
...
abstract class Idle<T> implements SymbolsState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$SymbolsStateCopyWithImpl<T, $Res, _$Loading<T>>
...
abstract class Loading<T> implements SymbolsState<T> {
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$SymbolsStateCopyWithImpl<T, $Res, _$Success<T>>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'SymbolsState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements SymbolsState<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$SymbolsStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'SymbolsState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements SymbolsState<T> {
